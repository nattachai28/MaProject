...
public class OneWay1 extends JPanel{
    private final ImageIcon oneway1 = new ImageIcon(this.getClass().getResource("/Image/OneWay2.jpg"));
    ...
    MCar mcar = new MCar();
    ArrayList<Car1> car = new ArrayList<>();
    ...
    public void paintComponent(Graphics g){
        if(crash == 1){
            ...
            this.remove(Bhome);
            int i;
            g.drawImage(oneway1.getImage(),0,0,1280,690,this);            
