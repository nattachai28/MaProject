...
public class OneWay2 extends JPanel{
    private final ImageIcon oneway = new ImageIcon(this.getClass().getResource("/Image/OneWay3.jpg"));
    ...
    MCar mcar = new MCar();
    ArrayList<Car2> car = new ArrayList<>();
